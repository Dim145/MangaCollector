    ...
    () => [
      {
        id: "nav-dashboard",
        kanji: "棚",
        label: t("palette.navDashboard"),
        path: "/dashboard",
      },
      {
        id: "nav-add",
        kanji: "加",
        label: t("palette.navAdd"),
        path: "/addmanga",
      },
      {
        id: "nav-calendar",
        kanji: "暦",
        label: t("palette.navCalendar"),
        path: "/calendrier",
      },
      {
        id: "nav-profile",
        kanji: "個",
        label: t("palette.navProfile"),
        path: "/profile",
      },
      ...
      // analytics. Kanji 帳 mirrors the StatsPage hero watermark.
      {
        id: "nav-stats",
        kanji: "帳",
        label: t("palette.navStats"),
        path: "/stats",
      },
      {
        id: "nav-seals",
        kanji: "印",
        label: t("palette.navSeals"),
        path: "/seals",
      },
      {
        id: "nav-settings",
      ...
      },
      {
        id: "nav-glossary",
        kanji: "字",
        label: t("palette.navGlossary"),
        path: "/glossary",
      },
      {
        id: "nav-help",
        kanji: "助",
        label: t("palette.navHelp"),
        path: "/aide",
      },
    ],
    [t],
