export default {
  ...
  rangement: {
    ...
    note: "Nota",
    delete: "Eliminar",
    confirmDelete: "¿Eliminar «{name}»? Sus tomos se quedan, solo sin lugar.",
    yes: "Sí, eliminar",
    no: "Conservar",
    moveUp: "Subir",
    moveDown: "Bajar",
    save: "Guardar",
    cancel: "Cancelar",
    emptyPlace: "Aún no hay nada colocado aquí.",
    tomes: "{n} tomo(s)",
    pickAll: "Seleccionar todo",
    clearPick: "Quitar selección",
    moveTo: "Mover {n} a",
    move: "Mover",
    moved: "{n} tomo(s) ahora en {place}.",
    scanHere: "Escanear en este lugar",
    scanning: "Escanea un lomo para colocarlo en {place}",
    scanUnknown: "{isbn} no está en tu estantería.",
    scanAlready: "{tome} ya está aquí.",
  ...
  inventory: {
    ...
    scope_place: "Un lugar",
    scopeAll: "Toda la estantería",
    pickSeries: "Elegir una serie",
    pickPlace: "Elegir un lugar",
    filterSeries: "Filtrar series…",
    start: "Empezar el recuento",
    resume: "Hay un recuento de {scope} empezado el {date} esperando.",
    resumeButton: "Continuar",
    discard: "Descartar",
    pointCamera: "Apunta la cámara a un lomo",
    progressWord: "presentes",
    lists: "Listas",
    finish: "Terminar",
    back: "Seguir escaneando",
    outcome_present: "Presente · {label}",
    outcome_repeat: "Ya contado · {label}",
    outcome_outside: "Fuera de este recuento · {label}",
    outcome_unknown: "Código desconocido · {label}",
    outcome_invalid: "No es un código de barras legible",
    tab_missing: "Faltan",
    tab_present: "Presentes",
    tab_other: "Otros",
    tapHint: "Toca un tomo para marcarlo a mano, sin código de barras.",
    lentHint: "prestado a {name}",
    outsideTitle: "ESCANEADOS, PERO FUERA DE ESTE RECUENTO",
    unknownTitle: "CÓDIGOS DESCONOCIDOS",
  ...
  scanPage: {
    ...
    tome: "tomo {n}",
    owned: "en posesión",
    notOwned: "no en posesión",
    lentTo: "prestado a {name}",
    openSeries: "Abrir la serie",
    addCopy: "Contar un ejemplar · ×{n}",
    addCopyHint: "Un ejemplar más de este tomo en la estantería.",
    addToLibrary: "Añadir a la biblioteca",
    scanNext: "Escanear el siguiente",
  },
  nav: {
  ...
  dashboard: {
    ...
    sortLabel: "ORDEN · 並",
    sortShort: "Ordenar",
    sortTitle: "Ordenar la estantería",
    sortOpen: "Abrir el menú de orden",
    sortByTitle: "Título",
    sortByAdded: "Fecha de adición",
    sortByUpdated: "Última modificación",
    sortByProgress: "Progreso",
    sortByMissing: "Tomos que faltan",
    sortByOwned: "Tomos en posesión",
    sortByAuthor: "Autor",
    sortByUpcoming: "Próxima salida",
    sortDirAsc: "Ascendente",
    sortDirDesc: "Descendente",
    sortFlip: "Invertir el orden",
  ...
  manga: {
    ...
    publisherCollectionAria: "Ver todas las series publicadas por {name}",
    editionLabel: "Edición",
    editionPlaceholder: "Estándar, Kanzenban, Deluxe…",
    editionCollectionAria: "Ver todas las series en la edición {name}",
    ...
    progressLabel: "LECTURA · 読",
    readingStatusPlanned: "Pendiente",
    readingStatusReading: "Leyendo",
    readingStatusPaused: "En pausa",
    readingStatusCompleted: "Terminada",
    readingStatusDropped: "Abandonada",
    readingStatusNone: "Sin empezar",
    readingStatusHint: "a mano, o siguiendo los tomos que marques como leídos",
    readingStarted: "Empezada",
    readingFinished: "Terminada",
    readingTimesRead: "Leída {n} veces",
  ...
  volume: {
    ...
    physicalLabel: "Ejemplar · 物",
    conditionLabel: "Estado",
    conditionNew: "Nuevo",
    conditionLikeNew: "Como nuevo",
    conditionGood: "Bueno",
    conditionFair: "Aceptable",
    conditionPoor: "Deteriorado",
    conditionUnrated: "sin valorar",
    locationLabel: "Dónde está",
    locationPlaceholder: "Estantería B · caja 3…",
  ...
  about: {
    version: "v2.13.2 · Archiva tu colección",
    heroStart: "Cada",
    heroAccent: "tomo",
    heroEnd1: ",",
    heroEnd2: "bellamente",
  ...
  offline: {
    ...
    retryNow: "Reintentar",
    retryNowAria: "Reintentar la sincronización ahora",
  ...
  activity: {
    ...
    seriesReread: "empezó {title} de nuevo — lectura n.º {n}.",
  ...
  importExternal: {
    ...
    mxInputKind: "Por exportación XML · oficial",
    mxBlurb:
      "Importa la lista exportada desde el propio MyAnimeList (Perfil → Exportar). Los tomos marcados como en posesión o leídos pasan a tu colección — sin usuario ni límite de peticiones.",
    mxInputTitle: "Tu exportación de MyAnimeList",
    mxInputLabel: "Fichero XML (.xml o .xml.gz)",
    mxPlaceholder: "mangalist_….xml.gz",
    mxHint:
      "En MyAnimeList: Perfil → Exportar → Lista de manga. Suelta aquí el .xml.gz descargado tal cual — se descomprime en tu navegador. Los tomos «retail» (en posesión) tienen prioridad sobre los leídos.",
  ...
  collection: {
    ...
    backToDashboard: "Volver al dashboard",
    kickerPublisher: "CATÁLOGO · 出版",
    kickerEdition: "FORMATO · 版",
    kindPublisher: "Editorial",
    kindEdition: "Edición",
    subtitlePublisher:
      "Todas las series que guardas bajo este sello, reunidas en un catálogo razonado.",
    subtitleEdition:
      "Todas las series coleccionadas en este formato particular — un cuaderno de todos tus ejemplares de igual corte.",
    singleSeries: "serie",
    multipleSeriesShort: "series",
    volumesUnit: "tomos",
    ...
    publishersStripAria: "Editoriales representadas en esta edición",
    publishersStripTitle: "Editoriales representadas",
  ...
  loans: {
    ...
    historyKicker: "TODOS LOS PRÉSTAMOS · 帳",
    historyOpen: "aún fuera",
    lentTimes: "prestado {n} veces",
    lastBack: "devuelto el {date}",
  ...
  friends: {
    ...
    event: {
      ...
      series_reread: "empezó {series} de nuevo — lectura n.º {count}.",
