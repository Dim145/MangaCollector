export default {
  ...
  rangement: {
    ...
    subtitle: "Shelves, boxes, rooms — each place knows what sits in it.",
    listHeading: "PLACES",
    ...
    note: "Note",
    delete: "Delete",
    confirmDelete: "Delete “{name}”? Its tomes stay, just without a place.",
    yes: "Yes, delete",
    no: "Keep",
    moveUp: "Move up",
    moveDown: "Move down",
    save: "Save",
    cancel: "Cancel",
    emptyPlace: "Nothing filed here yet.",
    tomes: "{n} tome(s)",
    pickAll: "Select all",
    clearPick: "Clear",
    moveTo: "Move {n} to",
    move: "Move",
    moved: "{n} tome(s) now in {place}.",
    scanHere: "Scan into this place",
    scanning: "Scan a spine to file it under {place}",
    scanUnknown: "{isbn} is not on your shelf.",
    scanAlready: "{tome} is already here.",
  ...
  inventory: {
    ...
    scope_place: "One place",
    scopeAll: "Whole shelf",
    pickSeries: "Pick a series",
    pickPlace: "Pick a place",
    filterSeries: "Filter series…",
    start: "Start the count",
    resume: "A count of {scope} started {date} is waiting.",
    resumeButton: "Resume",
    discard: "Discard",
    pointCamera: "Point the camera at a spine",
    progressWord: "present",
    lists: "Lists",
    finish: "Finish",
    back: "Resume scanning",
    outcome_present: "Present · {label}",
    outcome_repeat: "Already counted · {label}",
    outcome_outside: "Not in this count · {label}",
    outcome_unknown: "Unknown barcode · {label}",
    outcome_invalid: "Not a barcode we read",
    tab_missing: "Missing",
    tab_present: "Present",
    tab_other: "Other",
    tapHint: "Tap a tome to tick it by hand — no barcode needed.",
    lentHint: "out with {name}",
    outsideTitle: "SCANNED, BUT OUTSIDE THIS COUNT",
    unknownTitle: "UNKNOWN BARCODES",
  ...
  scanPage: {
    ...
    pointCamera: "Point the camera at a barcode — your shelf answers first.",
    onShelf: "On your shelf",
    notOnShelf: "Not on your shelf",
    looking: "Not on your shelf — asking the catalogues…",
    ...
    lentTo: "lent to {name}",
    openSeries: "Open the series",
    addCopy: "Count a copy · ×{n}",
    addCopyHint: "One more copy of this tome on the shelf.",
    addToLibrary: "Add to the library",
    scanNext: "Scan the next one",
  },
  nav: {
    scan: "Scan a barcode",
  ...
  dashboard: {
    ...
    sortLabel: "ORDER · 並",
    sortShort: "Sort",
    sortTitle: "Order the shelf",
    sortOpen: "Open sort menu",
    sortByTitle: "Title",
    sortByAdded: "Date added",
    sortByUpdated: "Last updated",
    sortByProgress: "Completion",
    sortByMissing: "Missing volumes",
    sortByOwned: "Volumes owned",
    sortByAuthor: "Author",
    sortByUpcoming: "Next release",
  ...
  manga: {
    ...
    publisherCollectionAria: "View every series published by {name}",
    editionLabel: "Edition",
    editionPlaceholder: "Standard, Kanzenban, Deluxe…",
    editionCollectionAria: "View every series in the {name} edition",
    ...
    progressLabel: "READING · 読",
    readingStatusPlanned: "Planned",
    readingStatusReading: "Reading",
    readingStatusPaused: "Paused",
    readingStatusCompleted: "Finished",
    readingStatusDropped: "Dropped",
    readingStatusNone: "Not started",
    readingStatusHint: "set by hand, or let it follow the tomes you mark read",
    readingStarted: "Started",
    readingFinished: "Finished",
    readingTimesRead: "Read through {n}×",
  ...
  volume: {
    ...
    conditionFair: "Fair",
    conditionPoor: "Worn",
    conditionUnrated: "not rated",
    locationLabel: "Where it lives",
    locationPlaceholder: "Shelf B · box 3…",
  ...
  about: {
    version: "v2.13.2 · Archive your collection",
    heroStart: "Every",
    heroAccent: "volume",
    heroEnd1: ",",
  ...
  activity: {
    ...
    seriesReread: "started {title} over — read-through no. {n}.",
  ...
  seals: {
    ...
    categoryHint: {
      ...
      seasonal: "Stamped only during specific times of year",
    },
    tiers: {
      sumi: "墨 · Common ink",
      hanko: "印 · Vermilion",
    ...
    codes: {
      ...
      kisetsu_sakura: {
        label: "桜 · Sakura",
        description:
          "Stamped in April or May, when the archive holds at least five series. The cherry-blossom season smiled on you.",
      },
      kisetsu_tanabata: {
        label: "七夕 · Tanabata",
        description:
          "Stamped in July, after five volumes read. The wishes tied to the bamboo carry the reading along.",
      },
      kisetsu_tsukimi: {
        label: "月見 · Tsukimi",
        description:
          "Stamped in September or October, when ten volumes have been read. The full moon lights the pages.",
      },
      kisetsu_kouyou: {
        label: "紅葉 · Kōyō",
        description:
          "Stamped in October or November, when three series are completed. The red leaves keep watch over the closed shelf.",
      },
      kisetsu_rinto: {
        label: "凜冬 · Rintō",
        description:
          "Stamped between December and February, the moment a series is completed. Winter seals the work into the register.",
      },
    },
  ...
  importExternal: {
    ...
    mxInputKind: "By XML export · official",
    mxBlurb:
      "Import the list you exported from MyAnimeList itself (Profile → Export). Volumes you marked as owned or read become your collection — no username lookup, no rate limit.",
    mxInputTitle: "Your MyAnimeList export",
    mxInputLabel: "XML file (.xml or .xml.gz)",
    mxPlaceholder: "mangalist_….xml.gz",
    mxHint:
      "On MyAnimeList: Profile → Export → Manga list. Drop the downloaded .xml.gz here as is — it is unpacked in your browser. Retail (owned) volumes take precedence over read volumes.",
  ...
  collection: {
    ...
    kindEdition: "Edition",
    subtitlePublisher:
      "Every series you keep under this imprint, gathered as a catalogue raisonné.",
    subtitleEdition:
      "Every series you've collected in this format — a logbook of all your copies of the same cut.",
    singleSeries: "series",
    multipleSeriesShort: "series",
    volumesUnit: "vols",
    ...
    publishersStripAria: "Publishers represented in this edition",
    publishersStripTitle: "Publishers represented",
  ...
  loans: {
    aria: "Lent volumes",
    title: "Manifest of absences",
    kicker: "LOANS · 預け",
    itemSingular: "volume out",
    itemPlural: "volumes out",
    overdueShort: "overdue",
    statusOverdue: "Overdue",
    statusDueSoon: "Due soon",
    statusActive: "Out",
    statusOpen: "Open-ended",
    daysOverdue: "+{n}d",
    stampAria: "{status} — lent to {borrower}",
    cardAria: "Volume {vol} of {name} lent to {borrower}",
    borrowerLabel: "Borrower",
    volNumLabel: "Vol",
    lentOn: "Lent",
    dueOn: "Return",
    unknownSeries: "Unknown series",
    lendCtaKicker: "LEND · 貸出",
    lendCtaTitle: "Lend this volume",
    lendAction: "Lend",
    returnAction: "Mark returned",
    updateAction: "Update",
    modalKickerLend: "NEW LOAN",
    modalKickerEdit: "EDIT LOAN",
    modalTitleLend: "Inscribe a loan",
    modalTitleEdit: "Edit inscription",
  ...
  snapshots: {
    ...
    kicker: "ARCHIVE · 印影",
    subtitle:
      "Capture the state of your shelf at a given moment. Each print is a dated witness nothing erases.",
    unitSingular: "print",
    unitPlural: "prints",
    ...
    captureSubtitle:
      "The print captures the silhouette of your shelf and the figures that describe it today.",
    captureSubmit: "Capture",
    capturing: "Capturing…",
    nameLabel: "Print name",
    notesLabel: "Notes",
    notesPlaceholder: "An intent, a memory, a reason…",
    defaultName: "Shelf · {month}",
    phaseRendering: "Drawing the image…",
    phaseUploading: "Filing into archive…",
    phaseDone: "Print sealed",
    phaseError: "Capture failed",
    statVolumes: "vols",
    statSeries: "series",
    openAria: "View print {name}",
  ...
  friends: {
    ...
    kicker: "ARCHIVE · 友",
    subtitle:
      "Follow other archivists. Their acquisitions, completions and milestones return to you as dated letters.",
    correspondentSingular: "correspondent",
    correspondentPlural: "correspondents",
    eventSingular: "missive",
    eventPlural: "missives",
    correspondentsTitle: "Correspondents",
    correspondentsEmpty: "No correspondents yet.",
    correspondentsEmptyHint:
      "Visit a public profile and tap “Follow” to open a postal route.",
    feedTitle: "Mail received",
    feedEmptyTitleNone: "Mailbox empty",
    feedEmptyTitleQuiet: "Quiet this month",
    feedEmptyBodyNone:
    ...
    followedDaysAgo: "since {n}d",
    followedMonthsAgo: "since {n} mo",
    backToDashboard: "Back to dashboard",
    unknownSeries: "a series",
    event: {
      fallback: "{type} · {series}",
      series_added: "added {series} to their archive.",
      series_removed: "removed {series} from their archive.",
      series_completed: "completed {series} — {count} volumes total.",
      series_reread: "started {series} over again — read-through {count}.",
